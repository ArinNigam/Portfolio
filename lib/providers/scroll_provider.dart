...
class ScrollProvider extends ChangeNotifier {
  ...
  ScrollController get detailedProjectScrollController =>
      _detailedProjectScrollController;
  ...
  void tableOfContentsListner(double height, double width) {
    if (_detailedProjectScrollController.offset > height) {
      tableOfContentsOffset = max(
          0, _detailedProjectScrollController.offset - height - width / 9.87);
    } else {
